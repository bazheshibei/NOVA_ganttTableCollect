...
export default {
  ...
  methods: {
    ...
    _proving() {
      ...
      /* 保存有用数据 */
      this.$store.commit('saveData', { name: 'filter_data', obj: arr, module: 'DhMl' })
    },
    /**
     * [增加条件]
     */
    ...
    reset() {
      ...
      this.$store.commit('saveData', { name: 'filter_data', obj: [], module: 'DhMl' })
      /* 重置分页 */
     ...
     */
    handleClose() {
      this.$store.commit('saveData', { name: 'isDialog', obj: false, module: 'DhMl' })
    },
    /**
     * [计算：表格高度]
     */
