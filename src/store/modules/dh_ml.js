  ...
  actions: {
    ...
    A_tableData({ state }) {
      ...
      if (!loadingPage) {
        ...
        /* 发起请求 */
        const name = '统计列表'
        const obj = { filter_data: JSON.stringify(filter_data), titleSearch: JSON.stringify(tableHeader), postEmpSearch: JSON.stringify(businessObj), type: 2, page: parseInt(pagenum) - 1, num: rownum, empid }
