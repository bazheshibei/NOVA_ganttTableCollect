...
export default {
  ...
  methods: {
    ...
    A_showAdd_1(index) {
      ...
      const { make_sample_id } = listObj[active][index]
      const host = window.location.origin + '/nova/'
      /* 发起请求 */
      // eslint-disable-next-line
      ui("open", {
        title: '款式打样信息',
        url: host + 'pages/makesamplerecord/makesamplerecordlist.jsp?type=dygj&make_sample_id=' + make_sample_id,
        onClose: function () {}
      })
    },
    /**
    ...
    A_showAdd_2(index) {
      ...
      ui("open", {
        title: '款式过款记录',
        url: host + 'pages/makesamplerecord/makesamplerecordlist.jsp?type=gkjl&make_sample_id=' + make_sample_id,
        onClose: function () {}
      })
    },
    /**
