  ...
  <div :style="[tableContent, btnLineStyle]">
    ...
    <div class="btnLine" :style="btnLineStyle">
      <div>
        ...
        <el-button type="primary" size="mini" @click="followUp">
          节点跟进
        </el-button>
        <!-- 变更节点 [未选中] -->
        <el-button type="primary" size="mini"
          :disabled="!choiceRow.item_node_id" @click="change"
        >
          变更节点
        </el-button>
        <!-- 取消完成 [未选中 || 未完成 || 完成方式 === 自动] -->
        <el-button type="primary" size="mini"
          :disabled="!choiceRow.item_node_id || choiceRow.is_complete === 0 || String(choiceRow.completion_method) === '2'" @click="cancel"
        >
          取消完成
        </el-button>
        <!-- 调整完成比例 [未选中 || 没有'节点完成ID'] -->
        <el-button type="primary" size="mini"
          :disabled="!choiceRow.item_node_id || !choiceRow.node_complete_id" @click="tuneUp"
        >
          调整完成比例
        </el-button>
      </div>
