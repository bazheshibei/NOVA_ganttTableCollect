...
<template>
  ...
  <div>
    ...
    >
      ...
      <el-table-column label="面料颜色" prop="material_color_name" min-width="120"></el-table-column>
      <el-table-column label="开发工厂" prop="material_provider_name" min-width="120"></el-table-column>
...
export default {
  ...
  computed: {
    ...mapState('MlFs', ['tableData_1', 'tableData_2', 'tableNodes', 'pageObj', 'loading'])
  },
  methods: {
    /**
     * [单元格样式]
