...
export default {
  data() {
    return {
      selectObj: [
        ...
        { label: '项目类型', value: 'material_item_type' },
        { label: '跟进人', value: 'material_follow_employeename' },
        { label: '面料名称', value: 'material_describe' },
        { label: '审核状态', value: 'audit_status' },
        { label: '提报人', value: 'reporter' },
        { label: '创建时间', value: 'report_time' },
        { label: '面料下达日期', value: 'matter_release_time' }
      ],
      valueType: {
        item_name: 'text',
        material_item_type: 'text',
        material_follow_employeename: 'text',
        material_describe: 'text',
        audit_status: 'text',
        reporter: 'text',
        report_time: 'timePicker',
        matter_release_time: 'timePicker'
      },
      typeArr: [
        { label: '包含', value: 'like' },
  ...
  methods: {
    ...
    _proving() {
      ...
      /* 保存有用数据 */
      this.$store.commit('saveData', { name: 'filter_data', obj: arr, module: 'MlXz' })
    },
    /**
     * [增加条件]
     */
    ...
    reset() {
      ...
      this.$store.commit('saveData', { name: 'filter_data', obj: [], module: 'MlXz' })
      /* 重置分页 */
     ...
     */
    handleClose() {
      this.$store.commit('saveData', { name: 'isDialog', obj: false, module: 'MlXz' })
    },
    /**
     * [计算：表格高度]
     */
