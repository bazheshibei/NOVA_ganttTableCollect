...
export default {
  ...
  computed: {
    ...mapState(['active']),
    ...mapState('DhDh', { dh: state => state.tableData_1, dh_loading: state => state.loadingPage }),
    ...mapState('DhMl', { ml: state => state.tableData_1, ml_loading: state => state.loadingPage }),
    ...mapState('DhGc', { gc: state => state.tableData_1, gc_loading: state => state.loadingPage })
  },
  methods: {
    /**
     * [切换：汇总表]
